...
public class ServerQueueTask implements Runnable {

    private final Barricade barricade;
    private final String serverName;

    public ServerQueueTask(Barricade barricade, String serverName) {
    ...
    @Override
    public void run() {
        barricade.getServerQueueManager().processQueues(serverName);
    }
